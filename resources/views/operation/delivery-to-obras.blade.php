...
<div class="container mt-4">
    ...
    <div class="modal fade" id="deliveryModal" tabindex="-1" aria-labelledby="deliveryModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="deliveryForm" method="POST" action="{{ route('delivery-to-obras.store') }}">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Obras</label>
                            <select name="obras_id" id="obras_id" class="form-select">
                                @foreach ($obrass as $o)
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <h5 class="card-title mb-3">Daftar Pengantaran ke Obras</h5>
                        ...
                        @forelse($deliveries as $d)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Hapus -->
                                    <form action="{{ route('delivery-to-obras.destroy', $d->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus data ini?')">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <div class="modal fade" id="ambilModal{{ $d->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('delivery-to-obras.take-result', $d->id) }}" method="POST">
                                            @csrf
                                            <div class="modal-header">
                                                <h5 class="modal-title">Ambil Hasil dari {{ $d->obras->name ?? 'Obras' }}</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                            </div>
                                            <div class="modal-body">
...
function editDelivery(delivery) {
    ...
    document.getElementById('obras_id').value = delivery.obras_id;
