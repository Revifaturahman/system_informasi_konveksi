...
@section('title', 'Laporan Obras')

@section('content')
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Laporan Obras</h4>
        <div>
    ...
    <table class="table table-striped align-middle">
        ...
        <tbody>
            @php
                $Obras = [
                    ['nama' => 'Obras 1', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Obras 2', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Obras 3', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                ];
            @endphp
