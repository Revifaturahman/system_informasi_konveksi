...
@section('title', 'Laporan Pemotong')

@section('content')
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Laporan Pemotong</h4>
        <div>
    ...
    <table class="table table-striped align-middle">
        ...
        <tbody>
            @php
                $Pemotong = [
                    ['nama' => 'Pemotong 1', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Pemotong 2', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Pemotong 3', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                ];
            @endphp

            @foreach ($Pemotong as $p)
                <tr>
                    <td>{{ $p['nama'] }}</td>
                    <td>{{ $p['jumlah'] }}</td>
                    <td>{{ $p['tanggal'] }}</td>
