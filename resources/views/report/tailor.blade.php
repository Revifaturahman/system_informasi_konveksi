...
@section('title', 'Laporan Penjahit')

@section('content')
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">Laporan Penjahit</h4>
        <div>
    ...
    <table class="table table-striped align-middle">
        ...
        <tbody>
            @php
                $penjahit = [
                    ['nama' => 'Penjahit 1', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Penjahit 2', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                    ['nama' => 'Penjahit 3', 'jumlah' => 15, 'tanggal' => '18/10/2025', 'gaji' => 1000000],
                ];
            @endphp
